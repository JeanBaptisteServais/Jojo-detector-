...
<br>
So we treat the picture, we clean the background (if the background isn't white, we trying to take contours (except the smaller contour who's represent noise, pixels that we do not want)
